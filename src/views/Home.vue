        ...
        <div class="panel-box">
          <div class="panel-style number-style">
            ...
            <ul class="radio-list">
              <li class="radio-item">
                <label>
                  <input type="radio" v-model="params.isCenter" value="0" id="radio1" hidden /> <label class="label" for="radio1"></label>
                  卡尺式
                </label>
              </li>
              <li class="radio-item">
                <label> <input type="radio" v-model="params.isCenter" value="1" id="radio2" hidden /> <label class="label" for="radio2"></label> 居中式</label>
              </li>
            </ul>
          </div>
          <div class="panel-style composing-style">
            ...
            <ul class="radio-list">
              <li class="radio-item">
                <label> <input type="radio" v-model="params.composing.hv" value="v" id="radio3" hidden /> <label class="label" for="radio3"></label> 竖排</label>
                <div class="dir-panel">
                  数值在
                  <p class="dir-wrap">
              ...
              <li class="radio-item">
                <label> <input type="radio" v-model="params.composing.hv" value="h" id="radio4" hidden /> <label class="label" for="radio4"></label> 横排</label>
                <div class="dir-panel">
                  数值在
                  <p class="dir-wrap">
...
.panel-box {
  ...
  .panel-style {
    ...
    input[type='radio']:checked + .label {
      border: none;
      border-radius: 0;
      background: url('../assets/img/radio-select-icon.png') no-repeat center/100% 100%;
    }
    &.number-style {
      display: flex;
      align-items: center;
